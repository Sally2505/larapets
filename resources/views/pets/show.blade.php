...
<div class="bg-[#0006] p-6 rounded-sm">
    ...
    {{-- Photo --}}
    <div class="avatar flex flex-col gap-2 items-center justify-center cursor-pointer hover:scale-110 transition ease-in">
    ...
    {{-- Data --}}
    <div class="flex gap-2 flex-col md:flex-row mt-6">

        {{-- Left --}}
        <ul class="list bg-[#0006] mt-4 text-white rounded-box shadow-md">
            <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Pet Information</li>

            <li class="list-row">
                <strong>Name:</strong> <span>{{ $pet->name }}</span>
            </li>

            <li class="list-row">
                <strong>Kind:</strong> <span>{{ $pet->kind }}</span>
            </li>

            <li class="list-row">
                <strong>Breed:</strong> <span>{{ $pet->breed }}</span>
            </li>

            <li class="list-row">
                <strong>Age:</strong> <span>{{ $pet->age }} years</span>
            </li>

            <li class="list-row">
                <strong>Weight:</strong> <span>{{ $pet->weight }} kg</span>
            </li>
        </ul>

        {{-- Right --}}
        <ul class="list bg-[#0006] mt-4 text-white rounded-box shadow-md">
            <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Additional Data</li>

            <li class="list-row">
                <strong>Description:</strong>
                <span>{{ $pet->description ?? 'No description available' }}</span>
            </li>

            <li class="list-row">
                <strong>Active:</strong>
                <span>{{ $pet->active ? 'Yes' : 'No' }}</span>
            </li>
